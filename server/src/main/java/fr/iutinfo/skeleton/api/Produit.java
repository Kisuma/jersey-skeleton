...
public class Produit implements Principal {
    ...
    public boolean equals(Object arg) {
        ...
        return nom.equals(produit.nom) && description.equals(produit.description) && prix==produit.prix && allergies.equals(produit.allergies) && stock==produit.stock;
    }
    @Override
	public String toString() {
		return "Produit [id=" + id + ", nom=" + nom + ", prix=" + prix + ", description=" + description + ", allergies="
